...
export interface I_FormData<T extends Record<string, TypedFormDataValue>> {
	/**
	...
	forEach<K extends keyof T>(callbackfn: (value: T[K], key: K, parent: I_FormData<T>) => void, thisArg?: unknown): void
}
